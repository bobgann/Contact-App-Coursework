...
@section('title','Contact App | Contact' . 'test')
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header card-title">
                            <h2 class="mb-0">{{$contact->first_name}}</h2>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-9 offset-md-3">
                                            ...
                                            <a href='{{ route('contacts.index') }}' class="btn btn-outline-secondary">Back
                                                to All Contacts</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
